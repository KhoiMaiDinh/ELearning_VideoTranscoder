...
@QueueEventsListener(QueueName.VALIDATE, { blockingTimeout: 300000 })
export class ValidateQueueEvents extends QueueEventsHost {
  private readonly logger = new Logger(ValidateQueueEvents.name);
