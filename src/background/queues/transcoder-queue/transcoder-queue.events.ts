import { QueueName } from 'src/constants/job.constant';
import {
  OnQueueEvent,
  QueueEventsHost,
  QueueEventsListener,
...
@QueueEventsListener(QueueName.TRANSCODER, { blockingTimeout: 300000 })
export class TranscoderQueueEvents extends QueueEventsHost {
  private readonly logger = new Logger(TranscoderQueueEvents.name);
